    ...
    <>
        ...
        <main className='flex w-full flex-col item-center justify-center'>
            <Layout className='pt-16'>
                ...
                <div className='!pt-8 grid w-full grid-cols-8 gap-16'>
                    <div className='!pl-12 col-span-3 flex flex-col items-start justify-start px-4 py-6'>
                    ...
                    <div className='col-span-3 relative h-max w-max rounded-2xl border-2 border-solid border-dark bg-light p-6'>
                        <Image src={me} alt='Oussama Abderraouf ATTIA' width={330} height={330} className='rounded-2xl' /> 
                    </div>
                </div>
            </Layout>
        </main>
