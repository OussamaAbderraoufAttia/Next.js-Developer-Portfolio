        ...
        <main className='flex w-full flex-col item-center justify-center'>
            <Layout className='pt-16'>
                ...
                <div className='grid w-full grid-cols-8 gap-16'>
                    ...
                    <div className='col-span-3 relative h-1/2 rounded-2xl border-2 border-solid border-dark
                    bg-light p-6
                    '>
                        <Image src={me} alt='Oussama Abderraouf ATTIA w-full h-auto rouned-2xl'/> 
                    </div>
